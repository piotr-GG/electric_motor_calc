...
class NumpyDataTransfer(DataStorageInterface):
    ...
    def export_data(data: MotorCalc, destination: str) -> bool:
        ...
        kwargs = {"limit": limit, "Ps" : Ps, "PAl": PAl, "Pss": Pss, "Pp": Pp, "losses_pssv": losses_pssv,
...
if __name__ == "__main__":
    ...
    limit, Ps, PAl, Pss, Pp, losses_ppv, losses_psv, losses_palv, losses_pssv = NumpyDataTransfer.import_data("no_jak_tam_2.npz")
    print(losses_palv)